...
// Code Here
let doubled = myNumbers.map(function(nums){
	return nums * 2
})
//////////////////PROBLEM 15////////////////////
...
// Code Here
let filtered = myNumbers.filter(nums => nums > 100)
...
// Code Here
let total = myNumbers.reduce((accum, num) => accum + num,0)
//////////////////PROBLEM 17////////////////////
...
// Code Here
let myNumbersIndex = []
	myNumbers.forEach(function (elem, index) {
...
// Code Here
let totallyAwesome = people.reduce((accum, person) => accum + person.awesomeLevel,0)
